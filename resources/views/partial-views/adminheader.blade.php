					...
					<div class="container">
						...
						<div class="collapse navbar-collapse offset" id="navbarSupportedContent">
							<ul class="nav navbar-nav menu_nav ml-auto">
								<li class="nav-item active"><a class="nav-link" href="{{ url('/admin') }}">Home</a></li> 
								...
								<li class="nav-item"><a class="nav-link" href="gallery.html">Medical Professionals</a></li> -->
                                @if(Auth::user())
								<li class="nav-item submenu dropdown">
                ...
                <div class="row">
                    <div class="col-lg-6  col-md-6 col-sm-6">
                        <div class="single-footer-widget">
                            ...
                            <p style="color:#ccc;">The ultimate aim of Doctors Charity is to build a legacy of service. We envision a day when medical professionals the world over will set a day aside out of their busy schedule every month to volunteer their times to providing free and qualitative healthcare in poor communities. </p>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="single-footer-widget">
